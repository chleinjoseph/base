      ...
      <div className="md:col-span-2">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Fill out the form to add a new post to the resources page.</CardDescription>
          </CardHeader>
          <CardContent>
      ...
      <div className="md:col-span-3">
        <Card>
            <CardHeader>
                ...
                <CardDescription>Manage and view all current blog posts.</CardDescription>
            </CardHeader>
            <CardContent>
